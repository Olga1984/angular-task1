////
/// @group wk-sass-utils.utilities.colors
...
/// Wolters Kluwer primary red - shade 2
///
/// @type Color
$wk-primary-red-shade2: #721017 !default;

/// Wolters Kluwer primary red - shade 1
///
/// @type Color
$wk-primary-red-shade1: #ac1822 !default;
...
/// Wolters Kluwer primary blue - shade 2
///
/// @type Color
$wk-primary-blue-shade2: #003d61 !default;
...
/// Wolters Kluwer primary green - shade 2
///
/// @type Color
$wk-primary-green-shade2: #425e10 !default;

/// Wolters Kluwer primary green - shade 1
///
/// @type Color
$wk-primary-green-shade1: #648d18 !default;
...
/// Wolters Kluwer primary gray - shade 1
///
/// @type Color
$wk-primary-gray-shade1: #353535 !default;

/// Wolters Kluwer primary gray - shade 2
///
/// @type Color
$wk-primary-gray-shade2: #232323 !default;


/// Wolters Kluwer secondary green - shade 2
///
/// @type Color
$wk-secondary-green-shade2: #004c40 !default;

/// Wolters Kluwer secondary green - shade 1
///
/// @type Color
$wk-secondary-green-shade1: #007261 !default;
...
/// Wolters Kluwer secondary orange - shade 2
///
/// @type Color
$wk-secondary-orange-shade2: #754700 !default;

/// Wolters Kluwer secondary orange - shade 1
///
/// @type Color
$wk-secondary-orange-shade1: #af6b00 !default;
...
/// Wolters Kluwer secondary purple - shade 2
///
/// @type Color
$wk-secondary-purple-shade2: #4a0639 !default;

/// Wolters Kluwer secondary purple - shade 1
///
/// @type Color
$wk-secondary-purple-shade1: #6f0955 !default;
...
/// Wolters Kluwer secondary blue - shade 2
///
/// @type Color
$wk-secondary-blue-shade2: #120c33 !default;

/// Wolters Kluwer secondary blue - shade 1
///
/// @type Color
$wk-secondary-blue-shade1: #1b124c !default;
...
/// Wolters Kluwer Highlight Blue
///
/// @type Color
$wk-highlight-blue: #6cf !default;

/// Wolters Kluwer Highlight Green
///
/// @type Color
$wk-highlight-green: #0fc !default;

/// Wolters Kluwer Highlight Pink
///
/// @type Color
$wk-highlight-pink: #ff6ecf !default;

/// Wolters Kluwer Highlight Orange
///
/// @type Color
$wk-highlight-orange: #fed009 !default;

/// Wolters Kluwer Highlight Yellow
///
/// @type Color
$wk-highlight-yellow: #ff0 !default;
...
$wk-primary-colors: (
    ...
    wkRed: (
        shade2: $wk-primary-red-shade2,
        shade1: $wk-primary-red-shade1,
        base: $wk-primary-red,
    ...
    wkGreen: (
        shade2: $wk-primary-green-shade2,
        shade1: $wk-primary-green-shade1,
    ...
    wkGray: (
        shade2: $wk-primary-gray-shade2,
        shade1: $wk-primary-gray-shade1,
...
$wk-secondary-colors: (
    wkGreen: (
        shade2: $wk-secondary-green-shade2,
        shade1: $wk-secondary-green-shade1,
    ...
    wkOrange: (
        shade2: $wk-secondary-orange-shade2,
        shade1: $wk-secondary-orange-shade1,
    ...
    wkPurple: (
        shade2: $wk-secondary-purple-shade2,
        shade1: $wk-secondary-purple-shade1,
    ...
    wkBlue: (
        shade2: $wk-secondary-blue-shade2,
        shade1: $wk-secondary-blue-shade1,
...
$wk-highlight-colors: (
    wkBlue: (
        base: $wk-highlight-blue
    ),
    wkGreen: (
        base: $wk-highlight-green
    ),
    wkPink: (
        base: $wk-highlight-pink
    ),
    wkOrange: (
        base: $wk-highlight-orange
    ),
    wkYellow: (
        base: $wk-highlight-yellow
    )
) !default;
...
///
/// @type Color
$wk-state-info-text-color: wk-primary-color(wkBlue) !default;
...
///
/// @type Color
$wk-input-disabled-color: wk-primary-color(wkGray, tint2) !default;
...
/// @type Map
$wk-context: (
    info: wk-primary-color(wkBlue),
    danger: wk-primary-color(wkRed),
    success: wk-primary-color(wkGreen),
    warning: wk-secondary-color(wkOrange)
);

/// High contrast version background color
///
/// @type Color
$wk-high-contrast-background-color: wk-primary-color(wkBlack) !default;

/// High contrast version foreground color
///
/// @type Color
$wk-high-contrast-foreground-color: $wk-highlight-yellow !default;

// High contrast version colors
///
/// @type Map
$wk-high-contrast-colors: (
    background: $wk-high-contrast-background-color,
    foreground: $wk-high-contrast-foreground-color
) !default;
