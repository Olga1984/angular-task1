...
/// Displays content for screen readers only.
///
/// @author [Gaël Poupard](https://gist.github.com/ffoodd/000b59f431e3e64e4ce1a24d5bb36034) - Modified by [GPO](https://gpo.wolterskluwer.com/)
/// @example scss - Usage
///   .element {
///       @include wk-sr-only;
///   }
...
/// Use in conjunction with `wk-sr-only` to display content when focused.
/// @author [Gaël Poupard](https://gist.github.com/ffoodd/000b59f431e3e64e4ce1a24d5bb36034) - Modified by [GPO](https://gpo.wolterskluwer.com/)
/// @example scss - Usage
///   .element {
///       @include wk-sr-only;
///       @include wk-sr-only-focusable;
///   }
///
/// @example css - Output
///   .element {
...
@mixin wk-arrow($box-edge: bottom, $edge-side: center, $arrow-size: 10px, $edge-side-offset: 0, $fill-color: wk-primary-color(wkBlack), $border-color: none, $border-style: border) {
    ...
    $transparent-white: rgba(wk-primary-color(wkWhite), 0);
    ...
    &::after,
    &::before {
        border: solid $transparent-white;
        content: ' ';
        height: 0;
        pointer-events: none;
        position: absolute;
...
/// Creates contextual styles
///
/// @param $ctx {String}  [info]  Context name string
/// @param $outline {Boolean} [false] Outline styles
@mixin wk-context($ctx: info, $outline: false) {
    @if ($outline) {
        background-color: wk-primary-color(wkWhite);
        border-color: map-get($wk-context, $ctx);
        color: map-get($wk-context, $ctx);
    } @else {
        background-color: map-get($wk-context, $ctx);
        color: wk-primary-color(wkWhite);
    }
}

/// Adds ctx attribute selectors
///
/// @param $outline {Boolean} [false] Outline styles
@mixin wk-has-context($outline: false) {
    &.wk-context-info,
    &[wk-context*='info'] {
        @include wk-context(info, $outline);
    }

    &.wk-context-success,
    &[wk-context*='success'] {
        @include wk-context(success, $outline);
    }

    &.wk-context-danger,
    &[wk-context*='danger'] {
        @include wk-context(danger, $outline);
    }

    &.wk-context-warning,
    &[wk-context*='warning'] {
        @include wk-context(warning, $outline);
    }
}

/// Set base styles font icon styles
///
/// @param {String} $family [wk-icons] - font family name
///
/// @example scss - Usage
///   .simple-icon {
...
@mixin wk-icon-base($family: 'wk-icons') {
    display: inline-block;
    font-smoothing: grayscale;
    font-style: normal;
    font-variant: normal;
...
/// Convenience selector for font icons
///
/// @param {String} $prefix [wk-icon-] - selector prefix
///
/// @example scss - Usage
///   @include wk-target-icons('simple-icon-') {
///     color: red;
///   }
///
/// @example css - Output
...
///    color: red;
///  }
@mixin wk-target-icons($prefix: 'wk-icon-') {
    [class^='#{$prefix}']::before,
    [class*=' #{$prefix}']::before {
        @content;
    }
